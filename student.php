...
$branch = mysqli_real_escape_string($conn,$_POST['branch']);
 ...
 $balance = $fees-$advancefees;
  ...
  $q1 = $conn->query("INSERT INTO student (sname,matricula,direccion,grado,joindate,contact,about,emailid,branch,balance,fees) VALUES ('$sname','$matricula','$direccion','$grado','$joindate','$contact','$about','$emailid','$branch','$balance','$fees')") ;
...
?>
		...
		?>
		  ...
		  <div class="col-sm-10">
		  <select name="class" class="form-control" id="grado" name="grado" required="">
